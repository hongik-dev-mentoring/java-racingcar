...
public class NameValidator {
	...
	public static final String NAME_LENGTH_EXCEPTION_MESSAGE = "자동차의 이름은 1자 이상 5자 이하여야 합니다.";
	public static final String EMPTY_CAR_NAME_MESSAGE = "자동차의 이름은 비어있을 수 없습니다.";
	public static final String NULL_CAR_NAME_MESSAGE = "자동차의 이름은 NULL일 수 없습니다.";
	public static final String DUPLICATE_CAR_NAME_MESSAGE = "자동차의 이름은 중복일 수 없습니다.";
