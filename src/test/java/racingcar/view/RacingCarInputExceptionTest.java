...
class RacingCarInputExceptionTest {
    ...
    void isNull() {
        ...
        assertThrows(IllegalArgumentException.class, () -> RacingCarInputException.handleNull(test));
    }
    ...
    void isEmpty() {
        ...
        assertThrows(IllegalArgumentException.class, () -> RacingCarInputException.handleEmpty(test));
    }
